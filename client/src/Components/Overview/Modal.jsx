      ...
      <div className="ov-modal">
        <div className='ov-thumbnail'>
          {this.props.photos.map((photo, index) => {
            return <img className='ov-thumbnail-photo' height='100px' width='100px' id={index} key={index} src={JSON.parse(photo.thumbnail_url)} onClick={(e) => { this.props.changePhoto(e); this.props.trackClicks(e, 'Overview')}}></img>
          })}</div>
        <img className='ov-modal-image ov-zoomedOut' src={JSON.parse(this.props.currentPhotoUrl)} alt={this.props.productInfo.description} onClick={(e) => {this.changeZoomLevel(e); this.props.trackClicks(e, 'Overview')}} onMouseMove={this.panOnMouseMove} ></img>
